...
```dart
import 'package:ding/routes.dart';
import 'package:flutter/material.dart';
...
I will be happy to answer any questions that you may have on this approach, and if you want to lend a hand with the ding then please feel free to submit an issue and/or pull request 🙂
